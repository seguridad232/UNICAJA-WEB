    ...
    <div className="px-6 mb-6">
      ...
      <div className="relative">
        <div className={`text-sm text-gray-600 leading-relaxed space-y-3 ${!isExpanded ? 'line-clamp-4' : ''}`}>
          <p>
            <strong>Dispositivo Seguro Unicaja</strong> es la aplicación oficial de autenticación reforzada de Unicaja. Diseñada para cumplir con la normativa europea PSD2, esta aplicación convierte tu móvil en tu llave de seguridad para operar en Banca Digital.
          </p>
          ...
          {isExpanded && (
            <>
              ...
              <p>
                Para garantizar la máxima seguridad en tus finanzas, Unicaja requiere un método de autenticación robusto. Esta app sustituye a la tarjeta de coordenadas y al SMS tradicional, ofreciendo un entorno encriptado de extremo a extremo.
              </p>
